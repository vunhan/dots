...
-- run_once("wicd-gtk")
run_once("ibus-daemon -dx")
run_once("urxvt -e tmux")
run_once("dropboxd")
-- run_once("sleep 10 && xscreensaver -nosplash")
run_once("sleep 3 && thunderbird")
run_once("xset m 8 1")
-- }}}
...
-- {{{ Tags
tags = {
   names = { "Skype", "Web", "Dev", "Term","Docs", "Files", "Dict", "Media", "Other" },
   layout = { layouts[9], layouts[1], layouts[7], layouts[9], layouts[7], layouts[7], layouts[10], layouts[1], layouts[6] }
}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Print", function () awful.util.spawn("scrot -e 'mv $f ~/Pics/Screen-Shots/ 2>/dev/null'") end),
    ...
    -- awful.key({ modkey }, "l", function () awful.util.spawn("tilda") end),
